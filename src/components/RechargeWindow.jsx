...
const RechargeWindow = () => {
    ...
    return (
        <div className='sm:h-[700px] md:h-[950px] flex flex-col   bg-white relative'>
            ...
            <div className="options items-start justify-center text-white flex flex-col pt-4 pb-4 mx-3 pl-2 bg-[orange]  ">
            ...
            <div className="fixed bottom-0 border-t border-confirm w-full bg-[#f7f7fa] px-5 z-50 ">
                <button onClick={handleRecharge} className='w-full flex-1 text-white bg-[orange] border-0 border-[rgba(215,215,215,0.6)] h-11 leading-10 px-5 text-center text-base block border-solid rounded-[500px] transition-all active:translate-y-1 duration-500 overflow-hidden relative '>
                    Submit Ref. Number
                </button>
