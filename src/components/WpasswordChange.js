                ...
                <header className="h-[50px] leading-[50px] block pb-[10px] bg-[#f8f9fb] border-0 border-b-[1px] border-[#e7e8ea]">
                    ...
                    <div className="item">
                        ...
                        <div className="flex flex-wrap items-center my-10 w-full justify-end ">
                            ...
                            <button className=' flex-1 text-white bg-[black] border-0 border-[rgba(215,215,215,0.6)] h-11 leading-10 px-5 text-center text-base block border-solid rounded-[500px] transition-all active:translate-y-1 duration-500 overflow-hidden relative ' onClick={handleRegister}>
                                Confirm
                            </button>
                        </div>
