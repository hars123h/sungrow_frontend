                        ...
                        <div className="recommended-items">
                            ...
                            <Link to={'/tasks'} className="flex items-center flex-col">
                                <div className="router flex items-center justify-center">
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M25.4861 7.47656H27.1643C28.4486 7.47656 29.5018 8.58594 29.5018 9.94844V24.9484C29.5018 26.3078 28.4518 27.4203 27.1643 27.4203H6.84238C5.55801 27.4203 4.50488 26.3078 4.50488 24.9484V9.94844C4.50488 8.58906 5.55488 7.47656 6.84238 7.47656H8.52051V8.80469C8.52051 9.37344 8.95801 9.83594 9.49551 9.83594H12.3018C12.8393 9.83594 13.2768 9.37031 13.2768 8.80469V7.47656H20.7299V8.80469C20.7299 9.37344 21.1674 9.83594 21.7049 9.83594H24.5111C25.0486 9.83594 25.4861 9.37031 25.4861 8.80469V7.47656ZM17.1779 21.8892L22.6713 16.3958C23.1198 16.0034 23.1198 15.2747 22.6153 14.7702C22.2229 14.3217 21.4942 14.3217 21.0457 14.7702L16.281 19.5349L13.8707 17.1245C13.4783 16.7321 12.8056 16.7321 12.4132 17.1245L12.3011 17.2366C11.9087 17.629 11.9087 18.3016 12.3011 18.694L15.6084 22.0013C16.0008 22.3937 16.6734 22.3937 17.0658 22.0013L17.1779 21.8892Z" fill="#e70012"></path>
                            ...
                            >
                                <div className="router flex items-center justify-center">
                                    <div>
                                        ...
                                        <FaDownload className='text-[#e70012]' size={25} />
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                                            <g clipPath="url(#clip0_2835_7115)">
                                                <path d="M27.7749 17.924C27.7749 19.3501 27.494 20.7622 26.9483 22.0797C26.4026 23.3973 25.6027 24.5944 24.5943 25.6028C23.5859 26.6112 22.3887 27.4111 21.0712 27.9569C19.7537 28.5026 18.3415 28.7835 16.9154 28.7835C15.4894 28.7835 14.0772 28.5026 12.7597 27.9569C11.4422 27.4111 10.245 26.6112 9.23663 25.6028C8.22824 24.5944 7.42834 23.3973 6.8826 22.0797C6.33686 20.7622 6.05598 19.3501 6.05599 17.924C6.05598 16.4979 6.33686 15.0858 6.8826 13.7682C7.42834 12.4507 8.22824 11.2535 9.23663 10.2451C10.245 9.23674 11.4422 8.43683 12.7597 7.89109C14.0772 7.34534 15.4894 7.06445 16.9154 7.06445C18.3415 7.06445 19.7537 7.34534 21.0712 7.89109C22.3887 8.43683 23.5859 9.23674 24.5943 10.2451C25.6027 11.2535 26.4026 12.4507 26.9483 13.7682C27.494 15.0858 27.7749 16.4979 27.7749 17.924Z" fill="#e70012"></path>
