    ...
    return (
        <>
            ...
            <div className="home-page flex flex-col">
                    ...
                    <div className="flex-1 recommended">
                        ...
                        <div className="recommended-items">
                            ...
                            <div className="flex items-center flex-col">
                                ...
                                <div className="recommended-items-title">Cash Exchange</div>
                            </div>
                            <div className="flex items-center flex-col">
                                <div className="router flex items-center justify-center">
                                    <div>
                ...
                <div role="dialog" aria-labelledby="Welfare channel" tabIndex="0" className={`van-dialog min-w-[30%] z-[2002] ${telegramopen}`} >
                    ...
                    <div className="van-hairline--top van-dialog__footer">
                        ...
                        <button type="button" className="van-button van-button--default van-button--large van-dialog__confirm van-hairline--left text-[rgb(196,71,58)]" >
                            <div className="van-button__content">
                ...
                <div role="dialog" aria-labelledby="Set Trade Password" tabIndex="0" className={`van-dialog min-w-[30%] z-[2004] ${wpwd} `} >
